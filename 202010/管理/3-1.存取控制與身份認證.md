...
安全套接層（SSH）密鑰：SSH密鑰是使用頻繁的存取控制協定，可提供對關鍵系統的直接根存取權。
    根(root)是根據預設有權存取Linux或其他Unix類似作業系統上所有命令及檔案的用戶名稱或帳號。
...
https://www.digitimes.com.tw/iot/article.asp?cat=130&cat1=40&id=0000581465_OE63GL9675S4GW41045O9
```
